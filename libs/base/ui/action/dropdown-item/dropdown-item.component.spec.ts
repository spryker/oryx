...
describe('DropdownItemComponent', () => {
  ...
  describe('when dropdown has text', () => {
    beforeEach(async () => {
      element = await fixture(
        html`<oryx-dropdown-item text="mock"></oryx-dropdown-item>`
      );
    });
  ...
  describe('when dropdown has a url', () => {
    beforeEach(async () => {
      element = await fixture(
        html`<oryx-dropdown-item url="mock"></oryx-dropdown-item>`
      );
    });
  ...
  describe('when dropdown has an icon', () => {
    beforeEach(async () => {
      element = await fixture(
        html`<oryx-dropdown-item .icon=${IconTypes.Add}></oryx-dropdown-item>`
      );
    });
    it('should render icon', () => {
      expect(element.renderRoot.querySelector('oryx-icon')).toHaveProperty(
        'type',
        IconTypes.Add
      );
    });
