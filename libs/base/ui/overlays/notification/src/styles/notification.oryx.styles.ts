...
export const notificationStyles = css`
  ...
  :host([type='${unsafeCSS(AlertType.Info)}'])::before {
  ...
  :host([type='${unsafeCSS(AlertType.Success)}'])::before {
  ...
  :host([type='${unsafeCSS(AlertType.Warning)}'])::before {
  ...
  :host([type='${unsafeCSS(AlertType.Error)}'])::before {
