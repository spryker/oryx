...
describe('DefaultIdentityService', () => {
  ...
  describe('get', () => {
    ...
    it.skip('should return an observable with anonymous user data', () => {
      setupInjector();
  ...
  describe('getHeaders', () => {
    ...
    it('should return an observable with anonymous user headers', () => {
      ...
      expect(callback).toHaveBeenCalledWith({
        [Headers.AnonymousCustomerUniqueId]: mockAnonymous,
      });
    });
    ...
    it('should return an observable with user headers', () => {
      ...
      expect(callback).toHaveBeenCalledWith({
        [Headers.Authorization]: `${mockToken.tokenType} ${mockToken.accessToken}`,
      });
    });
  });
});
