...
import { ProductListNormalizer } from '../../adapter/spryker-glue';
import { GlueProductListAdapter } from './glue-product-list.adapter';
...
describe('GlueProductCategoryAdapter', () => {
  ...
  it('should be provided', () => {
    expect(service).toBeInstanceOf(GlueProductListAdapter);
  });
