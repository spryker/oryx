...
import { ProductCategoryRelatedAdapter } from './product-category-related-list.adapter';

export class DefaultProductCategoryRelatedAdapter
  implements ProductCategoryRelatedAdapter
{
