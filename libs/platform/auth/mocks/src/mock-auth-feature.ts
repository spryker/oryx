import { authLoginComponent, loginLinkComponent, oauthHandlerComponent } from '@spryker-oryx/auth';
...
export class MockAuthFeature implements AppFeature {
  components: ComponentsInfo = [authLoginComponent, loginLinkComponent, oauthHandlerComponent];
