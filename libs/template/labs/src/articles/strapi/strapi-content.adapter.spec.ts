...
const url = `https://mapi.strapi.com/v1/spaces/${mockSpace}`;
const readonlyUrl = `https://api.strapi.com/v2/cdn/stories/`;

const mockLocale = 'en';

describe('DefaultStrapiContentAdapter', () => {
  ...
  beforeEach(() => {
    const testInjector = createInjector({
      providers: [
        ...
        { provide: StrapiApiUrl, useValue: mockSpace },
